...
<style>
    ...
    .product-name { 
        ...
        color: #0E2040; margin-bottom: 8px;
    }
    .section-header h2 { font-weight: 700; font-size: clamp(30px, 4vw, 44px); }
    /* Remove CN elements */
    .h2-cn, .hero-cn, .product-name-cn { display: none !important; }
</style>
</head>
"""
            ...
            <div class="container" style="padding: 40px;">
                <div class="dispenser-showcase" style="grid-template-columns: repeat(auto-fit, minmax(300px, 1fr)); gap: 40px; align-items: start;">
                    ...
                    <div class="dispenser-info">
                        ...
                        <h4 style="font-family:'Syne'; text-transform:uppercase; font-size:12px; color:#1665D8; margin-bottom:12px; letter-spacing:0.1em;" x-text="t('detailSpecs') || 'Technical Specs'"></h4>
                        <table class="spec-table">
                            <tr><td x-text="t('detailMaterial') || 'Material'"></td><td x-text="t('specIndustrial') || 'NSF Certified Industrial Grade'"></td></tr>
                            <tr><td x-text="t('detailCert') || 'Certification'"></td><td>NSF, ISO, Halal, CE</td></tr>
                            <tr><td x-text="t('detailLead') || 'Lead Time'"></td><td x-text="t('specLead') || '15-25 Days'"></td></tr>
                            <tr><td>OEM</td><td>Available</td></tr>
                        </table>
...
print("index.html fixed: Corrected products, languages, font deformation, and removed Chinese.")
